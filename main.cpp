...
int main(int argc, char* argv[]) {
    ...
    //     return 0;
    // }
    // cout << "before init: " << command << endl;
    // // experiment->init();
    //
    // // log file
    // // LOG.open(experiment->get_wd() / ("log_" + command + "_" + to_string(is_debug) + ".txt"));
    //
    // // if (is_debug) {
    // //     cout << "IS_DEBUG = true" << endl;
    // //     IS_DEBUG = true;
    // //     experiment->min_horizon = 1;
    // //     experiment->max_horizon = 3;
    // // }
